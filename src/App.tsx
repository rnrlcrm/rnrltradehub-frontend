...
import SalesConfirmationPage from './pages/SalesConfirmation';
...
const App: React.FC = () => {
  ...
  const renderPage = () => {
    ...
    switch (pageKey) {
      ...
      case 'sales-confirmation': return <SalesConfirmationPage currentUser={currentUser} currentOrganization={currentOrganization} currentFinancialYear={currentFinancialYear} addAuditLog={addAuditLog} />;
